	...
	<body class="homepage">
		<div id="page-wrapper">
			...
			<!-- Header -->
				<div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<h1><a href="#" id="logo">Assembly Warrior</a></h1>
								<hr />
								<p>A social dungeon game.</p>
							</header>
							<footer>
			...
			<!-- Banner -->
				<section id="banner">
					<header>
						<h2>Top dungeon <strong>Histories</strong>.</h2>
						<p> 
						</p>
					</header>
				</section>
			...
			<!-- Carousel -->
				<section class="carousel">
					<div class="reel">
						...
						<article>
							<a href="#" class="image featured"><img src="{{ asset('helios/images/pic01.jpg') }}" alt="" /></a>
							<header>
						...
						<article>
							<a href="#" class="image featured"><img src="{{ asset('helios/images/pic02.jpg') }}" alt="" /></a>
							<header>
						...
						<article>
							<a href="#" class="image featured"><img src="{{ asset('helios/images/pic03.jpg') }}" alt="" /></a>
							<header>
						...
						<article>
							<a href="#" class="image featured"><img src="{{ asset('helios/images/pic04.jpg') }}" alt="" /></a>
							<header>
						...
						<article>
							<a href="#" class="image featured"><img src="{{ asset('helios/images/pic05.jpg') }}" alt="" /></a>
							<header>
						...
						<div class="row">
							...
							<!-- Photos -->
								<section class="12u 12u(mobile)">
									...
									<div class="row 25%">
										<div class="3u">
											<a href="#" class="image fit"><img src="{{ asset('helios/images/pic10.jpg') }}" alt="" /></a>
										</div>
										<div class="3u">
											<a href="#" class="image fit"><img src="{{ asset('helios/images/pic11.jpg') }}" alt="" /></a>
										</div>
										<div class="3u">
											<a href="#" class="image fit"><img src="{{ asset('helios/images/pic12.jpg') }}" alt="" /></a>
										</div>
										<div class="3u">
											<a href="#" class="image fit"><img src="{{ asset('helios/images/pic13.jpg') }}" alt="" /></a>
										</div>
										<div class="3u">
											<a href="#" class="image fit"><img src="{{ asset('helios/images/pic14.jpg') }}" alt="" /></a>
										</div>
										<div class="3u">
											<a href="#" class="image fit"><img src="{{ asset('helios/images/pic15.jpg') }}" alt="" /></a>
										</div>
										<div class="3u">
											<a href="#" class="image fit"><img src="{{ asset('helios/images/pic14.jpg') }}" alt="" /></a>
										</div>
